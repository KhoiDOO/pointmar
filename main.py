...
def get_args_parser():
    ...
    parser.add_argument('--token_embed_dim', default=3, type=int, help='token output embedding dimension')
    ...
    parser.add_argument('--warmup_epochs', type=int, default=100, metavar='N', help='epochs to warmup LR')
